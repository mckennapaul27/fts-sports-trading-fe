  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div
            className="bg-dark-navy w-72 h-full shadow-lg flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 border-b border-gold/20 flex-shrink-0">
            ...
            <nav className="flex-1 flex flex-col p-4 overflow-y-auto">
              ...
              <div className="pt-4 mt-4 border-t border-gold/20 flex-shrink-0">
                <button
                  onClick={() => {
                    handleLogout();
                    setOpen(false);
