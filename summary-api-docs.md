...
```javascript
fetch("NEXT_PUBLIC_SERVER_URL/api/performance/systems")
  .then((res) => res.json())
...
fetch(`NEXT_PUBLIC_SERVER_URL/api/performance/stats/${systemId}`)
  .then((res) => res.json())
  .then((data) => {
...
const systemsResponse = await fetch(
  "NEXT_PUBLIC_SERVER_URL/api/performance/systems"
);
...
const statsResponse = await fetch(
  `NEXT_PUBLIC_SERVER_URL/api/performance/stats/${selectedSystemId}`
);
